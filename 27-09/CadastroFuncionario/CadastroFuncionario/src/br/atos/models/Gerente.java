...
public class Gerente extends Funcionario{
    ...
    public Gerente(String nome, Double salarioLiquido, String cpf, String regional, Double metaRegional, Endereco endereco) {
        super(nome, salarioLiquido, cpf, endereco);
